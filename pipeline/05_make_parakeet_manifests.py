...
def main():
    ...
    ap.add_argument("--out_dir", type=Path, default=Path("pipeline/manifests/parakeet"))
    args = ap.parse_args()
    ...
    df = meta.merge(
        labels,
        on=["subject_id", "meta_cohort", "audio_path"],
        how="inner",
        suffixes=("", "_bio"),
    )
            ...
            rows.append(
                {
                    ...
                    "duration": audio_duration_seconds(audio_abs),
